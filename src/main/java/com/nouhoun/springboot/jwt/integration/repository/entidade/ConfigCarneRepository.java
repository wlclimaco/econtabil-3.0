...
@Repository("ConfigCarneRepository")
public interface ConfigCarneRepository extends JpaRepository<ConfigCarne, Long> {

@Query("SELECT u  FROM ConfigCarne u WHERE u.id = :id")
ConfigCarne findConfigCarneById(Integer id);
